...
public class base {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		prop.load(fis);
		//Below line27 can be used in place of line28 so that we can execute using maven command in cmd prompt dynamically in any browser without open data.properties file but by passing following command
